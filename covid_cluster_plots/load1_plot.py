...
def plot_violin(covid_val, non_covid_val, ax, title, ylabel):
    ...
    ax.text(x=0+0.47, y=int(get_max_pdf(covid_val)[1]), s="{:.2f}".format(get_max_pdf(covid_val)[0]), fontsize=16, color="black", va="center")
    ax.text(x=1+0.28, y=int(get_max_pdf(non_covid_val)[1])+6, s="{:.2f}".format(get_max_pdf(non_covid_val)[0]), fontsize=16, color="black", va="center")
    ...
    #max_non_covid_val = np.max(non_covid_val)
        ...
        #ax.text(x=0-0.08, y=407, s=str(round(max_covid_val,1)), fontsize=16, color="black", va="center")
    #if max_non_covid_val > 400:
         #ax.text(x=1-0.08, y=407, s=str(round(max_non_covid_val, 1)), fontsize=16, color="black", va="center")
